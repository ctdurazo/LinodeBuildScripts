...
wget https://github.com/ctdurazo/christiandurazo.dev/blob/master/app/static/mailServerConfs/postfix/master.cf -O /etc/postfix/master.cf #TODO
wget https://github.com/ctdurazo/christiandurazo.dev/blob/master/app/static/mailServerConfs/postfix/main.cf -O /etc/postfix/main.cf #TODO
...
wget https://github.com/ctdurazo/christiandurazo.dev/blob/master/app/static/mailServerConfs/dovecot/dovecot.conf -O /etc/dovecot/dovecot.conf #TODO

#get opendkim config files
mv /etc/opendkim.conf /etc/opendkim.conf.bak
mv /etc/default/opendkim
wget https://github.com/ctdurazo/christiandurazo.dev/blob/master/app/static/mailServerConfs/opendkim/opendkim.conf -O /etc/opendkim.conf #TODO
wget https://github.com/ctdurazo/christiandurazo.dev/blob/master/app/static/mailServerConfs/opendkim/opendkim -O /etc/default/opendkim #TODO
